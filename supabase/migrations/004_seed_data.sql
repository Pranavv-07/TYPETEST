...
VALUES
    ('f0000000-0000-0000-0000-000000000001', 'Prof. Alex Vance (Proctor)', 'trainer@testtype.edu', '+91 98480 12345', 'EMP-CSE-01', 'd0000000-0000-0000-0000-000000000001', 'Assistant Professor & Proctor', 'trainer', crypt('trainer@123', gen_salt('bf')), 'active'),
    ('f0000000-0000-0000-0000-000000000002', 'Pranav Vedula (CSE Faculty)', 'mentor_pranav@testtype.edu', '+91 98480 54321', 'EMP-CSE-02', 'd0000000-0000-0000-0000-000000000001', 'Lead Technical Trainer', 'mentor_pranav', crypt('trainer@123', gen_salt('bf')), 'active'),
    ('f0000000-0000-0000-0000-000000000003', 'Faculty CSE Examination Cell', 'faculty_cse@testtype.edu', '+91 98480 98765', 'EMP-CSE-03', 'd0000000-0000-0000-0000-000000000001', 'Senior Examiner', 'faculty_cse', crypt('trainer@123', gen_salt('bf')), 'active')
ON CONFLICT (username) DO NOTHING;
...
VALUES
    ('50000000-0000-0000-0000-000000000001', '24P31A42S4', 'DANDEM SURYA VENKATA PHANISRI', '24P31A42S4@testtype.edu', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', '24P31A42S4', crypt('1234', gen_salt('bf')), 'active'),
    ('50000000-0000-0000-0000-000000000002', '24P31A05B3', 'Sri nithya Nimishakawi', '24P31A05B3@testtype.edu', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', '24P31A05B3', crypt('1234', gen_salt('bf')), 'active'),
    ('50000000-0000-0000-0000-000000000003', '24B11AI213', 'KURAMDASU GANESWARI', '24B11AI213@testtype.edu', 'c0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000002', '24B11AI213', crypt('1234', gen_salt('bf')), 'active'),
    ('50000000-0000-0000-0000-000000000004', '24P31A05A1', 'Vemula Sai Teja', '24P31A05A1@testtype.edu', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', '24P31A05A1', crypt('1234', gen_salt('bf')), 'active'),
    ('50000000-0000-0000-0000-000000000005', '24P31A05A2', 'Kondeti Naga Harsha', '24P31A05A2@testtype.edu', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', '24P31A05A2', crypt('1234', gen_salt('bf')), 'active')
...
VALUES
    ('e0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000001'),
    ('e0000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000001'),
    ('e0000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;
